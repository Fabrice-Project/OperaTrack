...
import { LayoutDashboard, FolderOpen, BarChart3, Settings, Building2, Route, Lightbulb, Zap, X, Bell, PieChart, TrafficCone, Wrench } from 'lucide-react';
...
const PATRIMOINE_ITEMS = [
  ...
  { to: '/patrimoine/equipements-divers', icon: Wrench,      label: 'Équipements divers' },
